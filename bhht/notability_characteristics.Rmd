...
"Notability" is a social construct whose definition can vary over time and among geographic locations.  The BHHT data includes four main attributes -- sex, era of birth, occupation, and region -- that can be used to understand the construction of notability in different contexts.
