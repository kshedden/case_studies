...
```{r}
m1 = lmer(decimalLatitude ~ (1 | species) + day + lonrad_sin_cen + lonrad_cos_cen + lonrad_sin2_cen + lonrad_cos2_cen, da)
summary(m1)
```
...
```{r}
m2 = lmer(decimalLatitude ~ (1 + day | species) + day + lonrad_sin_cen + lonrad_cos_cen + lonrad_sin2_cen + lonrad_cos2_cen, da)
summary(m2)
```
