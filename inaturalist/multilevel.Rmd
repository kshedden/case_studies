...
Below we fit a multilevel linear regression with random species intercepts and random day slopes for species. These two random effects are correlated with each other.  The estimated variance of the random day slope tells us to what extent different species ranges are moving (in terms of latitude) over time at different rates.
