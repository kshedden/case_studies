...
Office hours: Tuesday 9:30-11, Thursday 3:30-5 (starting 1/13)
...
is intended for second year students in the Applied Statistics and Data
Science master's programs. Students taking this course should already have
completed master's level courses in probability, theoretical statistics,
...
- Provide exposure to new statistical methods.
...
lectures introducing new areas and unfamiliar ideas. Regular attendance and
participation is expected. Students are expected to be present during student
presentations and participate in discussions. This is an in-person
seminar-style course and lectures will not be recorded or streamed.
...
this course. Grading and announcements will use the course canvas site.

## Coursework

The coursework will consist of multiple writing assignments and one
presentation. All work will be conducted individually, and each student will
complete one memo or give one presentation for each case study. There will be
approximately 8 assignments, one for each case study.

Each writing assignment or presentation will address a prompt provided by the
instructor. You will have significant latitude in your approach, but the
analyses are not completely open-ended -- you should focus on addressing the
issues raised in the writing prompt and build on the ideas discussed in class.

The writing assignments ("memos") will be 2-3 pages in length and will
resemble a memo prepared by a professional data analyst, summarizing methods
and findings from your data analysis.

Each student will be required to give one presentation to the class during the
course of the semester. It should consist of 4-5 slides, and should be
delivered within 5 minutes, with an additional 2-3 minutes for questions and
discussion.  Presentation will start with the second case study.

Writing for this course is short and focused. The text component of a report
should generally be 2-3 pages in length, with 3 pages being a hard limit. You
should include graphs and tables as appropriate, and these do not count toward
the page limit. Only include graphs and tables that directly support your main
claims, and be sure to directly refer to each graph or table in your memo.
...
fonts and margins. To facilitate grading, you must title each document in the
form “uniqname stats 504 assignment X”, where “uniqname” is your UM login id
and X=1, 2, ... is the assignment number. Share all your assignments with the
instructor and GSI (but please do not send us an email notification when you
share the document). You should not edit any assignment after the due date,
note that all edits are tracked in Google Docs. Instructors will provide
feedback directly on your Google Doc. Do not remove or unshare these documents
until the course is complete and final grades have been awarded.

## Case studies and datasets

The case studies will cover a variety of areas of inquiry in domains including
human health, social and behavioral science, and natural science. We will
...
days two prepare your report. All assignments are mandatory, and extensions
...
and writing, but you may discuss analysis strategies and coding issues with
other students. Each student should develop and maintain their own code to
conduct the analysis in each project.
...
violation of academic integrity and will result in a score of zero on the
assignment, and may also be referred to the LSA or Rackham Honor Council.

You may use large language models to assist in your writing and coding, and
you do not need to acknowledge this. However note that the current generation
of LLMs, while powerful, has a simplistic "understanding" of applied
statistics. Furthermore, your writing is expected to build on the ideas
discussed in lectures, and no LLM is aware of exactly what we cover and
emphasize in our lectures.

## Grading

Your course grade will be an unweighted average of scores received on all
submitted assignments (both written memos and your presentation). Each
assignment will be scored according to the following rubric:
...
- Methods/approach (25 points): Is the analytic approach appropriate? Are
  analytic decisions justified? Are strengths and limitations of the chosen
  approaches adequately discussed? Are all analysis methods adequately
...
- Findings/interpretation (25 points): Does the analysis provide insight
  related to the primary motivating question? Are the conclusions stated
  explicitly and supported by the analysis and reported results? Are findings
  appropriately qualified?

## Some major themes of this course are:

- Formulating meaningful and tractable questions based on research goals
...
The memos written in this course reflect the type of routine writing done by
data analysts in many business and academic settings. These are short writing
assignments and are intended to document a data analysis -- they are not
essays written for general audiences. Your writing should focus on a specific
question, presenting your analysis and findings that address that question.
You generally should provide one paragraph motivating the research question,
and this motivating paragraph may be somewhat less technical than the
remainder of the memo. Apart from this brief introduction, your writing should
exclusively focus on analysis and findings.
...
behind the data, and who are also knowledgeable about statistics at a master's
level or higher. You do not need to didactically review all methods that you
use, but you should state the key properties of analytic methods that justify
their application, along with any relevant limitations.
...
semester. You should carefully study the
[writing tips](https://github.com/kshedden/case_studies/blob/main/methods/writing-tips.md)
which contain more detailed guidance for writing in this course.

- Write in an appropriate academic or business tone. Do not write casually,
  but also avoid excessively formal language.

- Organize your content so that your writing has a focused message, with each
  paragraph contributing a distinctly to this message.
