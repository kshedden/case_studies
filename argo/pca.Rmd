...
The mean profiles for temperature and salinity.
...
Flip signs in two sets of CCA loadings to make them easier to understand in a plot.
...
Use a combined PCA/CCA approach to relate temperature and salinity. Produce plots for a sequence of dimensions for the PCA dimension reduction.
...
SIR is a dimension reduction regression (DR) method.  Here we will use it doidentify factors within the temperature data that predict latitude.
