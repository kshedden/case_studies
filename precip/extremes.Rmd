Investigate the tails of a distribution of daily precipitation totals, considering the possibility that the tails may have either a powerlaw or an exponential tail.  Then estimate m-observation returns to quantify the risk for heavy precipitation events.
...
Assess the empirical Bayes estimate of the GPD parameters. Use copula to induce serial dependence.
...
Estimate the tail parameter (alpha) using empirical Bayes fit to a generalized Pareto distribution.
