...
The total population per county, transformed like the county-level data.

```{r}
totpop = apply(demogx, 1, sum)^0.25
```
...
```{r}
# Wayne county MI, Santa Clara CA, Bristol MA, Cook IL, Pennington SD, Los Angeles CA
