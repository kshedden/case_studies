...
In this setting, a kernel is a bivariate function $K(\cdot, \cdot)$
...
One way to use a kernel in practice is as follows.  Let ${\bf K}$
...
for including the Lanczos method for finding a limited number of leading
...
the dependent variable $y$ on $v_1, \ldot, v_q$.  It turns out that
